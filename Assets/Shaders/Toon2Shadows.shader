...
Shader "Custom/Toon 2 Shadows"
{
    Properties
    {
        ...
        _OutlineSmoothness ("Outline Smoothness", Range(0, 1)) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 fullColor = texColor * ( diffuseLight + specularLight * _SpecularIntensity );
                return float4( fullColor, 1 );
            }
        ...
        Pass {
            ...
            {
                float3 pos = v.vertex.xyz + v.normal * _OutlineThickness * 0.1;
